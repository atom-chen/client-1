...
#define APP_KEY @"EXmdoKCZUCjtvGyUcSsSXBO1"
...
- (void)application:(UIApplication *)application didRegisterForRemoteNotificationsWithDeviceToken:(NSData *)deviceToken
{
        ...
        [[Frontia getPush] bindChannel:^(NSString *appId, NSString *userId, NSString *channelId) {
            [[Frontia getPush] setTag:@"test" tagOpResult:^(int count, NSArray *failureTag) {
...
didReceiveRemoteNotification:(NSDictionary *)userInfo
{
    ...
    if (application.applicationState == UIApplicationStateActive) {
        ...
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"你有新推送"
...
{
    [[IosSDKHelper sharedSKDHelper] application:application openURL:url sourceApplication:@"" annotation:nil];
