...
const u32 PACKAGE_FILE_SIGN = 'ZPKZ';
const u32 CURRENT_VERSION = '3030';
...
struct PackageHeader
{
	...
	u32	mainVersion;			//主版本号
	// end [4/10/2013 Panruixing]	u32 reserved[18];
};
#pragma pack()
...
class Package : public IPackage
{
	...
	friend class ZpWriteCompressFile;
...
public:
	...
	// add by [4/10/2013 Panruixing]
	virtual void setMainVersion(u8 version);
	virtual u8	 getMainVersion() const;
	virtual void setSubVersion(u32 version);
	virtual u32	 getSubVersion() const;
	virtual void setOldSubVersion(u32 version);
	virtual u32  getOldSubVersion() const;
